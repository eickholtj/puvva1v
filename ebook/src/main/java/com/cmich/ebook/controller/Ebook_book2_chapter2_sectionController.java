...
public class Ebook_book2_chapter2_sectionController {
	...
	//GET method /book2_chapter2_section --> Reads list of sections from the database.

	@RequestMapping(value="/book2_chapter2_section", method=RequestMethod.GET)
	public ModelAndView books(){

		ModelAndView modelAndView = new ModelAndView();
		// We set the view name 'book2_chapter2_section' to which the data need to be rendered
		modelAndView.setViewName("book2_chapter2_section");
		// This operation will list all the sections present in the 'book2_chapter2_section'
