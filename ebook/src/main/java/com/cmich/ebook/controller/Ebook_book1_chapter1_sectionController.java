...
public class Ebook_book1_chapter1_sectionController {
	...
	//GET method /book1_chapter1_section --> Reads list of sections from the database.

	@RequestMapping(value="/book1_chapter1_section", method=RequestMethod.GET)
	public ModelAndView books(){

		ModelAndView modelAndView = new ModelAndView();
		// We set the view name 'book1_chapter1_section' to which the data need to be rendered
		modelAndView.setViewName("book1_chapter1_section");
		// This operation will list all the sections present in the 'book1_chapter1_section'
