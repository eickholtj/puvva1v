...
public class Ebook_book3_chapter1_sectionController {
	...
	//GET method /book3_chapter1_section --> Reads list of sections from the database.

	@RequestMapping(value="/book3_chapter1_section", method=RequestMethod.GET)
	public ModelAndView books(){

		ModelAndView modelAndView = new ModelAndView();
		// We set the view name 'book3_chapter1_section' to which the data need to be rendered
		modelAndView.setViewName("book3_chapter1_section");
		// This operation will list all the sections present in the 'book3_chapter1_section'
